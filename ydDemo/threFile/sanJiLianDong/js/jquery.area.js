...
function selectP(p) {
	...
	/*图片*/
	/*img也可以换成字符，如> |*/
    var img='<img src="images/tu1219/dijin_ico.png" alt="" style="width: 0.3rem;height: 0.56rem;margin: 0 0.3rem;">';
	expressArea = province[p] + img;/*间隔样式*/
